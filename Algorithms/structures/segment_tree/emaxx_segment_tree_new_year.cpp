...
namespace {
	...
	TEST(emaxx_segment_tree_tests, new_year_problem_test) {
		...
		t.update_range(vertex_range[11].s, vertex_range[11].e, 1);
		q = t.get(vertex_range[5].s, vertex_range[5].e);
		EXPECT_EQ(3, bit_count(q.mask));

		t.update_range(vertex_range[12].s, vertex_range[12].e, 1);
		t.update_range(vertex_range[13].s, vertex_range[13].e, 1);

		t.update_range(vertex_range[14].s, vertex_range[14].e, 1);
		t.update_range(vertex_range[15].s, vertex_range[15].e, 1);
		t.update_range(vertex_range[16].s, vertex_range[16].e, 1);

		t.update_range(vertex_range[17].s, vertex_range[17].e, 1);
		t.update_range(vertex_range[18].s, vertex_range[18].e, 1);
		t.update_range(vertex_range[19].s, vertex_range[19].e, 1);

		t.update_range(vertex_range[20].s, vertex_range[20].e, 1);
		t.update_range(vertex_range[21].s, vertex_range[21].e, 1);
		t.update_range(vertex_range[22].s, vertex_range[22].e, 1);
