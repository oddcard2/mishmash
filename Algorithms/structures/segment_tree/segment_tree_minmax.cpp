...
namespace {
	...
	TEST(emaxx_segment_tree_tests, sum_test) {
		...
		EXPECT_EQ(3, t.get(0, 4).maxv);

		EXPECT_EQ(3, t.get(1, 3).maxv);
		EXPECT_EQ(0, t.get(1, 2).maxv);
